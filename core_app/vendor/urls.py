...
urlpatterns = [
    ...
    path(
        "orders/<int:pk>/", VendorOrderDetailView.as_view(), name="vendor-order-detail"
    ),
    path(
        "orders/<int:pk>/accept/",
        VendorOrderAcceptView.as_view(),
        name="vendor-order-accept",
    ),
    path(
        "orders/<int:pk>/packed/",
        VendorOrderPackedView.as_view(),
        name="vendor-order-packed",
    ),
    path(
        "orders/<int:pk>/ready/",
        VendorOrderReadyView.as_view(),
        name="vendor-order-ready",
    ),
    # earnings
    path("earnings/", VendorEarningsView.as_view(), name="vendor-earnings"),
    path(
        "earnings/summary/",
        VendorEarningsSummaryView.as_view(),
        name="vendor-earnings-summary",
    ),
    # payouts
